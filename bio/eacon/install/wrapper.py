...
if snakemake.params.get("OncoScan", True) is True:
    shell('wget "https://partage.gustaveroussy.fr/pydio_public/b88fb8?dl=true&file=/OncoScan.na33.r4_0.1.0.tar.gz" -O {out_dir}/OncoScan.na33.r4_0.1.0.tar.gz {log}')
    shell('R  --vanilla CMD INSTALL --clean --data-compress=gzip {out_dir}/OncoScan.na33.r4_0.1.0.tar.gz {log}')

    shell('wget "https://partage.gustaveroussy.fr/pydio_public/582a03?dl=true&file=/OncoScan.na36.r1_0.1.0.tar.gz" -O {out_dir}/OncoScan.na36.r1_0.1.0.tar.gz {log}')
...
if snakemake.params.get("OncoScanCNV", True) is True:
    shell('wget "https://partage.gustaveroussy.fr/pydio_public/cd59c8?dl=true&file=/OncoScanCNV.na33.r2_0.1.0.tar.gz" -O {out_dir}/OncoScanCNV.na33.r2_0.1.0.tar.gz {log}')
    shell('R  --vanilla CMD INSTALL --clean --data-compress=gzip {out_dir}/OncoScanCNV.na33.r2_0.1.0.tar.gz {log}')

    shell('wget "https://partage.gustaveroussy.fr/pydio_public/41d8af?dl=true&file=/OncoScanCNV.na36.r1_0.1.0.tar.gz" -O {out_dir}/OncoScanCNV.na36.r1_0.1.0.tar.gz {log}')
...
if snakemake.params.get("CytoScan750K", True) is True:
    ...
    shell('wget "https://partage.gustaveroussy.fr/pydio_public/656d13?dl=true&file=/CytoScan750K.Array.na36.r1_0.1.0.tar.gz" -O {out_dir}/CytoScan750K.Array.na36.r1_0.1.0.tar.gz {log}')
...
if snakemake.params.get("CytoScanHD", True) is True:
    shell('wget "https://partage.gustaveroussy.fr/pydio_public/bc4b54?dl=true&file=/CytoScanHD.Array.na33.r4_0.1.0.tar.gz" -O {out_dir}/CytoScanHD.Array.na33.r4_0.1.0.tar.gz {log}')
    shell('R  --vanilla CMD INSTALL --clean --data-compress=gzip {out_dir}/CytoScanHD.Array.na33.r4_0.1.0.tar.gz {log}')

    shell('wget "https://partage.gustaveroussy.fr/pydio_public/24b026?dl=true&file=/CytoScanHD.Array.na36.r1_0.1.0.tar.gz" -O {out_dir}/CytoScanHD.Array.na36.r1_0.1.0.tar.gz {log}')
...
if snakemake.params.get("norm", True) is True:
    shell('wget "https://partage.gustaveroussy.fr/pydio_public/e6fe22?dl=true&file=/rcnorm_0.1.5.tar.gz" -O {out_dir}/rcnorm_0.1.5.tar.gz {log}')
    shell('R  --vanilla CMD INSTALL --clean --data-compress=gzip {out_dir}/rcnorm_0.1.5.tar.gz {log}')

    shell('wget "https://partage.gustaveroussy.fr/pydio_public/083305?dl=true&file=/affy.CN.norm.data_0.1.2.tar.gz" -O {out_dir}/affy.CN.norm.data_0.1.2.tar.gz {log}')
