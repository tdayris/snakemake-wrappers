...
.. code-block:: python
    ...
    rule get_genome:
        ...
        wrapper:
            "0.72.0-493-g8b815973b/bio/reference/ensembl-sequence"
    ...
    rule get_annotation:
        ...
        cache: True  # save space and time with between workflow caching (see docs)
        wrapper:
            "0.72.0-493-g8b815973b/bio/reference/ensembl-annotation"
    ...
    rule samtools_faidx_reference:
        ...
        group: "index_fasta"
        wrapper:
            "0.72.0-493-g8b815973b/bio/samtools/faidx"
    ...
    rule create_dict:
        ...
        group: "index_fasta"
        wrapper:
            "0.72.0-493-g8b815973b/bio/picard/createsequencedictionary"
    ...
    rule get_variation_with_contig_lengths:
        ...
        wrapper:
            "0.72.0-493-g8b815973b/bio/reference/ensembl-variation"
