...
.. code-block:: python
    ...
    rule get_genome:
        ...
        wrapper:
            "0.71.1-473-g5572d4839/bio/reference/ensembl-sequence"
    ...
    rule get_annotation:
        ...
        cache: True  # save space and time with between workflow caching (see docs)
        wrapper:
            "0.71.1-473-g5572d4839/bio/reference/ensembl-annotation"
    ...
    rule create_dict:
        ...
        group: "index_fasta"
        wrapper:
            "0.71.1-473-g5572d4839/bio/picard/createsequencedictionary"
    ...
    rule get_variation_with_contig_lengths:
        ...
        wrapper:
            "0.71.1-473-g5572d4839/bio/reference/ensembl-variation"
