...
.. code-block:: python
    ...
    rule deseq2:
        ...
        wrapper:
            "0.72.0-558-g97f44f15f/bio/deseq2/DESeq"
    ...
    rule deseq2_dataset_from_tximport:
        ...
        wrapper:
            "0.72.0-558-g97f44f15f/bio/deseq2/DESeqDataSetFromTximport/"
    ...
    rule tximport:
        ...
        log:
            "logs/tximport.log"
        wrapper:
            "0.72.0-558-g97f44f15f/bio/tximport"
    ...
    rule tx_to_gene:
        ...
        wrapper:
            "0.72.0-558-g97f44f15f/bio/gtf/tx2gene"
