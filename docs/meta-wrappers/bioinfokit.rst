...
.. code-block:: python
    ...
    rule bioinfokit_pcaplots:
        ...
        log:
            "logs/pca.log"
        wrapper:
            "0.72.0-523-gc911c3b69/bio/bioinfokit/pca"
    ...
    rule bioinfokit_volcanoplot:
        ...
        wrapper:
            "0.72.0-523-gc911c3b69/bio/bioinfokit/volcanoplot"
    ...
    rule bioinfokit_sample_heatmap:
        ...
        wrapper:
            "0.72.0-523-gc911c3b69/bio/bioinfokit/heatmap"
    ...
    rule bioinfokit_maplot:
        ...
        wrapper:
            "0.72.0-523-gc911c3b69/bio/bioinfokit/maplot"
    ...
    rule filter_deseq2:
        ...
        wrapper:
            "0.72.0-523-gc911c3b69/bio/pandas/deseq2_merge"
    ...
    rule gene_to_gene:
        ...
        wrapper:
            "0.72.0-523-gc911c3b69/bio/gtf/tx2gene"
