...
project = "Snakemake-Unofficial-API"
date = datetime.now()
copyright = "Snakemake itself: 2014-{year}, Johannes Koester".format(year=date.timetuple()[0])
...
latex_documents = [
    ("index", "Snakemake.tex", "Snakemake Documentation", "Thibault Dayris", "manual"),
]
...
man_pages = [
    ("index", "snakemake-api", "Snakemake Unofficial API Documentation", ["Thibault Dayris"], 1)
]
...
texinfo_documents = [
    (
        "index",
        "Snakemake",
        "Snakemake Unofficial Documentation",
        "Thibault Dayris",
        "Snakemake",
