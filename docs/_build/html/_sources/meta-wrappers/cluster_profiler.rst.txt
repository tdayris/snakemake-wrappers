...
.. code-block:: python
    ...
    rule cluster_profiler_upsetplot:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/pathview"
    ...
    rule cluster_profiler_upsetplot:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/upsetplot"
    ...
    rule cluster_profiler_heatplot:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/heatplot"
    ...
    rule cluster_profiler_cnetplot:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/cnetplot"
    ...
    rule cluster_profiler_dotplot:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/dotplot"
    ...
    rule cluster_profiler_barplot:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/barplot"
    ...
    rule cluster_profiler_enrich_go:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/enrichGO"
    ...
    rule translate_genes_identifiers_hg38:
        ...
        wrapper:
            "0.72.0-560-g28998a654/bio/clusterProfiler/bitr_GRCh38"
