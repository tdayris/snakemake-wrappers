...
.. code-block:: python
    ...
    rule cluster_profiler_upsetplot:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/pathview"
    ...
    rule cluster_profiler_upsetplot:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/upsetplot"
    ...
    rule cluster_profiler_heatplot:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/heatplot"
    ...
    rule cluster_profiler_cnetplot:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/cnetplot"
    ...
    rule cluster_profiler_dotplot:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/dotplot"
    ...
    rule cluster_profiler_barplot:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/barplot"
    ...
    rule cluster_profiler_enrich_go:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/enrichGO"
    ...
    rule translate_genes_identifiers_hg38:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/clusterProfiler/bitr_GRCh38"
