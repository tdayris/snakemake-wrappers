...
.. code-block:: python
    ...
    rule get_genome:
        ...
        wrapper:
            "0.72.0-528-gf5b56fa9a/bio/reference/ensembl-sequence"
    ...
    rule get_annotation:
        ...
        cache: True  # save space and time with between workflow caching (see docs)
        wrapper:
            "0.72.0-528-gf5b56fa9a/bio/reference/ensembl-annotation"
    ...
    rule get_variation_with_contig_lengths:
        ...
        wrapper:
            "0.72.0-528-gf5b56fa9a/bio/reference/ensembl-variation"
