...
.. code-block:: python
    ...
    rule get_genome:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/reference/ensembl-sequence"
    ...
    rule get_annotation:
        ...
        cache: True  # save space and time with between workflow caching (see docs)
        wrapper:
            "0.72.0-551-g3f16566da/bio/reference/ensembl-annotation"
    ...
    rule get_variation_with_contig_lengths:
        ...
        wrapper:
            "0.72.0-551-g3f16566da/bio/reference/ensembl-variation"
