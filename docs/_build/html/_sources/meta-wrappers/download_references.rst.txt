...
.. code-block:: python
    ...
    rule get_genome:
        ...
        wrapper:
            "0.71.1-435-g5ccb306a4/bio/reference/ensembl-sequence"
    ...
    rule get_annotation:
        ...
        cache: True  # save space and time with between workflow caching (see docs)
        wrapper:
            "0.71.1-435-g5ccb306a4/bio/reference/ensembl-annotation"
    ...
    rule samtools_faidx_reference:
        ...
        group: "index_fasta"
        wrapper:
            "0.71.1-435-g5ccb306a4/bio/samtools/faidx"
    ...
    rule create_dict:
        ...
        group: "index_fasta"
        wrapper:
            "0.71.1-435-g5ccb306a4/bio/picard/createsequencedictionary"
    ...
    rule get_variation_with_contig_lengths:
        ...
        wrapper:
            "0.71.1-435-g5ccb306a4/bio/reference/ensembl-variation"
