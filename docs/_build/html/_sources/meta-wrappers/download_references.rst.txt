...
.. code-block:: python
    ...
    rule get_genome:
        ...
        wrapper:
            "v0.69.0-414-g111cf6d28/bio/reference/ensembl-sequence"
    ...
    rule get_annotation:
        ...
        cache: True  # save space and time with between workflow caching (see docs)
        wrapper:
            "v0.69.0-414-g111cf6d28/bio/reference/ensembl-annotation"
    ...
    rule samtools_faidx_reference:
        ...
        group: "index_fasta"
        wrapper:
            "v0.69.0-414-g111cf6d28/bio/samtools/faidx"
    ...
    rule create_dict:
        ...
        group: "index_fasta"
        wrapper:
            "v0.69.0-414-g111cf6d28/bio/picard/createsequencedictionary"
    ...
    rule get_variation_with_contig_lengths:
        ...
        wrapper:
            "v0.69.0-414-g111cf6d28/bio/reference/ensembl-variation"
