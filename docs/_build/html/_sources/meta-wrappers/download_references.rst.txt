...
.. code-block:: python
    ...
    rule get_genome:
        ...
        wrapper:
            "v0.69.0-416-gc814694dd/bio/reference/ensembl-sequence"
    ...
    rule get_annotation:
        ...
        cache: True  # save space and time with between workflow caching (see docs)
        wrapper:
            "v0.69.0-416-gc814694dd/bio/reference/ensembl-annotation"
    ...
    rule samtools_faidx_reference:
        ...
        group: "index_fasta"
        wrapper:
            "v0.69.0-416-gc814694dd/bio/samtools/faidx"
    ...
    rule create_dict:
        ...
        group: "index_fasta"
        wrapper:
            "v0.69.0-416-gc814694dd/bio/picard/createsequencedictionary"
    ...
    rule get_variation_with_contig_lengths:
        ...
        wrapper:
            "v0.69.0-416-gc814694dd/bio/reference/ensembl-variation"
