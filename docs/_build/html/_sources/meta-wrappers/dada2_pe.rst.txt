...
.. code-block:: python
    ...
    rule dada2_quality_profile_pe:
        ...
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/quality-profile"
    ...
    rule dada2_filter_trim_pe:
        ...
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/filter-trim"
    ...
    rule dada2_learn_errors:
        ...
        threads: 1 # set desired number of threads here
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/learn-errors"
    ...
    rule dada2_dereplicate_fastq:
        ...
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/dereplicate-fastq"
    ...
    rule dada2_sample_inference:
        ...
        threads: 1 # set desired number of threads here
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/sample-inference"
    ...
    rule dada2_merge_pairs:
        ...
        threads: 1 # set desired number of threads here
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/merge-pairs"
    ...
    rule dada2_make_table_pe:
        ...
        threads: 1 # set desired number of threads here
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/make-table"
    ...
    rule dada2_remove_chimeras:
        ...
        threads: 1 # set desired number of threads here
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/remove-chimeras"
    ...
    rule dada2_collapse_nomismatch:
        ...
        threads: 1 # set desired number of threads here
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/collapse-nomismatch"
    ...
    rule dada2_assign_taxonomy:
        ...
        threads: 1 # set desired number of threads here
        wrapper:
            "0.79.0-2121-g9eee8d1be/bio/dada2/assign-taxonomy"
