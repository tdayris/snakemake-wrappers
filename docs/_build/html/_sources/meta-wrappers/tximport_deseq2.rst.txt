...
.. code-block:: python
    ...
    rule deseq2:
        ...
        wrapper:
            "0.72.0-610-g1b61cb767/bio/deseq2/DESeq"
    ...
    rule deseq2_dataset_from_tximport:
        ...
        wrapper:
            "0.72.0-610-g1b61cb767/bio/deseq2/DESeqDataSetFromTximport/"
    ...
    rule tximport:
        ...
        log:
            "logs/tximport.log"
        wrapper:
            "0.72.0-610-g1b61cb767/bio/tximport"
    ...
    rule tx_to_gene:
        ...
        wrapper:
            "0.72.0-610-g1b61cb767/bio/gtf/tx2gene"
