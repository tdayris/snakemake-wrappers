...
.. code-block:: python
    ...
    rule deseq2:
        ...
        wrapper:
            "0.74.0-690-g395727bdf/bio/deseq2/DESeq"
    ...
    rule deseq2_dataset_from_tximport:
        ...
        wrapper:
            "0.74.0-690-g395727bdf/bio/deseq2/DESeqDataSetFromTximport/"
    ...
    rule tximport:
        ...
        log:
            "logs/tximport.log"
        wrapper:
            "0.74.0-690-g395727bdf/bio/tximport"
    ...
    rule tx_to_gene:
        ...
        wrapper:
            "0.74.0-690-g395727bdf/bio/gtf/tx2gene"
