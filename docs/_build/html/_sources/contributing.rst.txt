...
Create and install the following environment::

  mamba create -n test-snakemake-wrappers -c conda-forge -c bioconda -c defaults snakemake pytest conda snakefmt black  sphinxcontrib-apidoc sphinx sphinx_rtd_theme pyyaml sphinx-copybutton markupsafe==2.0.1 mistune=0.8.4 m2r
  conda activate test-snakemake-wrappers


Then use the following commands::

  sphinx-apidoc -o api_reference/ ../../bigr_pipelines/common/python
  m2r ../bigr_pipelines/rnaseq/readme.md
  find ../ -type f -name "readme.rst" | while read READMD; do echo ln -sfr "${READMD}" "readme/long/$(basename $(dirname ${READMD})).rst"; done
  make html