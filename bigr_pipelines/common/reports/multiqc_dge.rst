Please find attached the aggregated quality report. This report also contains information about the differential expression analysis (PCA, MA-plot, etc), for `{{snakemake.wildcards.comparison}}`.
