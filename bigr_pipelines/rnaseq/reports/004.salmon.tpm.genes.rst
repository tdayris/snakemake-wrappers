This file contains all TPM normalized counts for all samples. One row for a gene, one column for a sample. The last columns contains additional gene informations
