...
rule multiqc_config:
    ...
    output:
        multiqc_config = temp("multiqc/DGE_considering_factor_{factor}_comparing_{test}_vs_{ref}/multiqc_config.yaml"),
        lots = [
...
rule plot_deseq_genes:
    ...
    output:
        ...
        gene_plots=report(
            ...
            caption=snakemake.workflow.source_path("reports/009.gene_expression_plot.rst"),
            subcategory="{comparison}"
        ),
