...
for (invcf in files_to_process) {
    ...
    if(length(as.character(seqnames(input_mutect)))>0){
        ...
        Canonical_NM <- paste(Canonical_NM, collapse = ',')
        Canonical_Protein_position <- paste(Canonical_Protein_position, collapse = ',')
        Canonical_Amino_acids <- paste(Canonical_Amino_acids, collapse = ',')
        Canonical_IMPACT <- paste(Canonical_IMPACT, collapse = ',')
        Canonical_Consequence <- paste(Canonical_Consequence, collapse = ',')
        ...
        rm(
            ...
            Hotspot,i,IMPACT,IMPACT_splitted,inExon,Method, name_normal,
