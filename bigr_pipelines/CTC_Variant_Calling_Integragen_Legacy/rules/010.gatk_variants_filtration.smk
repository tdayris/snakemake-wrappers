...
rule gatk_variant_filtration_wbc_baseline:
    input:
        gvcf="gatk/select_variants/{sample}_{version}_{manip}.g.vcf",
...
rule gatk_variant_filtration_ctc_baseline:
    input:
        gvcf="gatk/select_variants/{sample}_{version}_{manip}_{nb}.g.vcf",
        fasta=config["ref"]["fasta"],
    output:
...
rule gatk_variant_filtration_baseline:
    input:
        gvcf="gatk/select_variants/{sample}.baseline.g.vcf",
        fasta=config["ref"]["fasta"],
    output:
