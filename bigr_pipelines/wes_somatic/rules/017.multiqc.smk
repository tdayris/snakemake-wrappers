rule multiqc_variant:
    ...
    retries: 1
    params:
        extra="--module fastp --module sambamba --module samtools --module snpeff",
    log:
        "logs/multiqc.log",
    wrapper:
        "bio/multiqc"
...
rule multiqc_mapping:
    ...
    retries: 1
    params:
        extra="--module fastp --module sambamba --module samtools",
    log:
        "logs/multiqc.log",
    wrapper:
        "bio/multiqc"
...
rule multiqc_fusions:
    ...
    retries: 1
    params:
        extra="--module fastp --module sambamba --module samtools --module snpeff --module star",
    log:
        "logs/multiqc.log",
    wrapper:
        "bio/multiqc"
